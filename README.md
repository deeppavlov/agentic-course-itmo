...
мои предложения:
- свой агентский цикл в виде графа вместо word2vec
- линейный атеншен
- маленькие домашки вместо чтения статей
...
- Классы отказов: prompt injection, экфильтрация, зацикливание, потеря состояния
- Требования инфраструктуры: изоляция, хранение состояния, сеть, durability
...
- Собирать eval-набор и мерить качество метриками, а не ощущениями
...
- Критическим разбором статей и переносом их идей в собственный код
...
| Неделя | Блок | Занятия | Пар |
|---|---|---|---|
| 1 | Блок 1. Фундамент | Лекция 1 | 1 |
| 2 | Блок 1 | Лекция 2 + Семинар 1 | 2 |
| 3 | Блок 1 | Лекция 3 + Семинар 2 | 2 |
| 4 | Блок 2. Проблемы | Лекция 4 + Семинар 3 + **Проекты: вводное** | 3 |
| 5 | Блок 2 | Лекция 5 + Семинар 4 | 2 |
| 6 | Блок 3. Техника | Лекция 6 + Семинар 5 + **Чекпоинт 1** | 3 |
| 7 | Блок 3 | Лекция 7 + Семинар 6 | 2 |
| 8 | Блок 3 | Лекция 8 + Семинар 7 + **Чекпоинт 2** | 3 |
| 9 | Блок 3 | Лекция 9 + Семинар 8 | 2 |
| 10 | Блок 4. Бенчмарки | Лекция 10 + **Чекпоинт 3 (финальная защита)** | 2 |
| — | Экзамен | Экзамен по статьям (2 пары) | 2 |
| **Итого** | | **10 лекций + 8 семинаров + 4 проектных + 2 экзамен** | **24** |
...
**Отбор:** заявка → отборочный тест, набор до 24 человек. [Форма заявки](https://forms.yandex.ru/cloud/6a878b30d0468825567c4880) — мотивационное письмо, CV, телеграм.
...
**Разборы статей — 50 баллов.** За семестр проходит **8 семинаров** (недели 2–9). В течение семестра студент разбирает статьи на семинарах перед группой: задаёт вопросы и отвечает на них. Для максимального балла нужно поучаствовать в нескольких семинарах. Чтобы выступать на семинаре, сначала нужно сдать допуск.
